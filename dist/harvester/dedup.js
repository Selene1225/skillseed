...
import { listAllExperiences, updateExperienceMeta, moveExperienceScope } from "../store/file-store.js";
...
export function isDuplicateExperience(newContent, newTags) {
...
export function fixScopeBeforeDedup(all) {
    let fixed = 0;
...
export function findDupClusters(all) {
    const n = all.length;
...
export function mergeCluster(exps, brainCli, dryRun) {
    for (const e of exps) {
...
export function buildTagGroups(all) {
