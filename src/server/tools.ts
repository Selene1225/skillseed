...
export function registerTools(server: McpServer): void {
  ...
  server.tool(
    "seed_log",
    "Record a work experience, lesson, or best practice. Use when the user discovers something useful, makes a mistake, or establishes a pattern.",
    {
  ...
  server.tool(
    "seed_recall",
    "Search past work experiences. Use before starting tasks to bring relevant context, or when the user asks about past lessons.",
    {
  ...
  server.tool(
    "seed_preference_get",
    "Get user preferences (language, email style, work hours, etc). Call at conversation start to personalize responses.",
    {
